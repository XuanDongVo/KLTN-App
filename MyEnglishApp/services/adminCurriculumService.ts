...
export const adminCurriculumService = {
  ...
  restoreUnit: (unitId: number) => request<AdminCurriculumTree>(`/api/admin/curriculum/units/${unitId}/restore`, json('POST')),
  ...
  restoreLesson: (lessonId: number) => request<AdminCurriculumTree>(`/api/admin/curriculum/lessons/${lessonId}/restore`, json('POST')),
  ...
  restoreActivity: (activityId: number) => request<AdminCurriculumTree>(`/api/admin/curriculum/activities/${activityId}/restore`, json('POST')),
